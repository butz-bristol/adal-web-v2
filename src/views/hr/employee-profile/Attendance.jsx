...
const Attendance = () => {
  ...
  const { employee_profile, userProfile } = useSelector((state) => state.users);
    ...
    <Grid container spacing={1}>
      <Grid item lg={6} xs={12} sx={{ p: 0 }}>
        {clockedIn ? (
          ...
          >
            <Typography variant="h6">You are clocked in</Typography>
          </Box>
        ) : breakStarted ? (
          <Box
            sx={{
          ...
          >
            <Typography variant="h6">Currently on break</Typography>
          </Box>
        ) : (
          <Box
            sx={{
          ...
          >
            <Typography variant="h6">You are clocked out</Typography>
          </Box>
        )}
        ...
        {userProfile.isHrAdmin && (
          <>
            <Button
              ...
              onClick={() => {
                dispatch(createTimesheet(employee_profile));
              }}
            >
              Generate
            </Button>
            ...
            <Table>
              ...
              <TableBody>
                {attendances
                  .filter(
                    (attendance) =>
                      attendance.userId?._id === employee_profile._id
                  )
            ...
            <Table>
              ...
              <TableBody>
                {breaks
                  .filter(
                    (break_time) =>
                      break_time.userId?._id === employee_profile._id
                  )
