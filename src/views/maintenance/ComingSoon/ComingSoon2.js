...
// assets
import imageBlock from 'src/assets/images/maintenance/img-soon-block.svg';
import imageBlueBlock from 'src/assets/images/maintenance/img-soon-blue-block.svg';
import imageDarkGrid from 'src/assets/images/maintenance/img-soon-grid-dark.svg';
import imageGrid from 'src/assets/images/maintenance/img-soon-grid.svg';
import imagePurpleBlock from 'src/assets/images/maintenance/img-soon-purple-block.svg';
          ...
          <Grid item xs={12}>
            <CardMediaWrapper>
              <CardMedia
                component="img"
                image={
                  theme.palette.mode === 'dark' ? imageDarkGrid : imageGrid
                }
                title="Slider5 image"
              />
