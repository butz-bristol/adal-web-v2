      ...
      <Stack direction={'row'} mb={1} justifyContent={'space-between'}>
        ...
        >
          <Box width={150}>
            <FormControl fullWidth>
              <InputLabel id="date-filter">Filter</InputLabel>
              <Select
                label="Filter"
                labelId="date-filter"
                value={dateFilter}
        ...
        <Stack direction={'row'} spacing={1} alignItems={'center'}>
          <Button
            color="primary"
            variant="contained"
            endIcon={<IconTableExport size={17} />}
...
const BankAccountModal = ({ open, close, handleOpen }) => {
  const dispatch = useDispatch();
  ...
  const handleAddItem = () => {
    setData([...data, { account_no: '', amount: 0, remarks: '', date: '' }]);
  };
