...
import CollegeAndTESDACancelPaymentEntry from 'src/components/finance/CollegeAndTESDACancelPaymentEntry';
import K12CancelPaymentEntry from 'src/components/finance/K12CancelPaymentEntry';
import {
  clearStudentInfo,
  fetchAllOtherFees,
    ...
    <Stack>
      ...
      {student?.student_department &&
        ...
        student?.student_department?.department_name !==
          'Technical Education and Skills Development Authority (TESDA)' ? (
          <K12CancelPaymentEntry
            student_id={selectedStudent?._id}
            academic_year={academic_year_id}
          />
        ) : (
          <CollegeAndTESDACancelPaymentEntry
            semester={semester_id}
            student_id={selectedStudent?._id}
            academic_year={academic_year_id}
          />
