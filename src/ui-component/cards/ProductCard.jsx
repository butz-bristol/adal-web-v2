...
import { addProduct } from 'src/store/slices/cart';
import { openSnackbar } from 'src/store/slices/snackbar';
import SkeletonProductPlaceholder from 'src/ui-component/cards/Skeleton/ProductPlaceholder';
import MainCard from './MainCard';

// assets
import ShoppingCartTwoToneIcon from '@mui/icons-material/ShoppingCartTwoTone';

const prodImage = require.context('src/assets/images/e-commerce', true);
...
const ProductCard = ({
  ...
  const addCart = () => {
    dispatch(
      addProduct(
        { id, name, image, salePrice, offerPrice, color, size: 8, quantity: 1 },
