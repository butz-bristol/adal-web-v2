...
import {
  Payments,
  StudentLedger,
} from 'src/components/cashier/CollegeAndTESDAPaymentEntry';
...
const CollegeAndTESDACancelPaymentEntry = ({
  student_id,
  academic_year,
  semester,
}) => {
          ...
          dispatch(
            ...
            .then((res) => {
              if (res.meta.requestStatus === 'fulfilled') {
                ...
                toast.success('Payment successfully cancelled');
                if (studentLedger?._id) {
                  dispatch(
                    updateStudentLedger({
...
export default CollegeAndTESDACancelPaymentEntry;
