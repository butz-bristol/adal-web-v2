...
const MonthlyCashReceipts = ({ month, data, accumulatedData }) => {
  return (
    <Document author="Bridge360" title="Monthly Cash Reports">
...
export default MonthlyCashReceipts;
