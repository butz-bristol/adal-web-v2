...
import {
  getStudent,
  updateCollegeEnrollment,
  updateStudent,
  updateTESDAEnrollment,
...
import {
  ...
  fetchStudentInvoiceByStudent,
  updateStudentInvoice,
} from '../../features/financeFeatures/financeSlice';
...
const CollegeAndTESDAPaymentEntry = ({
  student_id,
  academic_year,
  semester,
}) => {
  ...
  const { collegeStudentLoad, studentProfile, tesdaStudentLoad } = useSelector(
  ...
  const monthlyScheme = college_payment_scheme?.payment_scheme?.find(
          ...
          dispatch(
            ...
            .then((res) => {
              if (res.meta.requestStatus === 'fulfilled') {
                ...
                // Check if ledger exists and update and fetch ledger
  ...
  useEffect(() => {
    ...
    dispatch(fetchStudentInvoiceByStudent(student_id));
  }, [dispatch, student_id]);
  ...
  return (
    <Stack mt={2} spacing={2}>
      ...
      {isCreatingPayment && <LoadingScreen />}

      <Payments
        open={showPayments}
        handleClose={handleHidePayments}
        payment_scheme={college_payment_scheme}
      />
      ...
      <ORPreview
        ...
        tuitionParticular={tuitionParticular}
      />
                ...
                <TableCell>
                  <FormControl fullWidth>
                    <Select
                      ...
                      sx={{ mb: '21px' }}
                    >
                      {college_payment_scheme?.payment_scheme
...
const StudentLedger = ({ open, handleClose }) => {
  ...
  return (
    <Modal open={open} onClose={handleClose}>
      ...
      >
        <TableContainer>
          <Table size="small" aria-label="student ledger table">
            <TableHead>
              <TableRow>
              ...
              <TableRow>
                ...
                <TableCell align="center">Collected by</TableCell>
...
export default CollegeAndTESDAPaymentEntry;
