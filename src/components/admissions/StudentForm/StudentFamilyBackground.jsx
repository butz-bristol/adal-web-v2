        ...
        <Grid container item spacing={2}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_father_contact_number || ''}
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_father_email_address || ''}
              label="Email Address"
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_father_occupation || ''}
              label="Occupation"
            />
          </Grid>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_mother_contact_number || ''}
              label="Contact Number"
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_mother_email_address || ''}
              label="Email Address"
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_mother_occupation || ''}
              label="Occupation"
            />
          </Grid>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_guardian_name || ''}
          ...
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_guardian_contact_number || ''}
              label="Contact Number"
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_guardian_email_address || ''}
              label="Email Address"
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              onChange={handleChange}
              value={student.student_guardian_occupation || ''}
              label="Occupation"
            />
          </Grid>
        </Grid>
