...
const StudentInformation = () => {
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid container item xs={12} md={4} alignItems="center" spacing={2}>
        <Grid item>{student_gender === 'Male' ? <IconGenderMale /> : <IconGenderFemale />}</Grid>
        <Grid item sm>
      ...
      <Grid container item xs={12} md={4} alignItems="center" spacing={2}>
        ...
        <Grid item sm>
          <Typography variant="subtitle1">{student_sexual_orientation}</Typography>
      ...
      <Grid container item xs={12} md={4} alignItems="center" spacing={2}>
        ...
        <Grid item sm>
          <Typography variant="subtitle1">{student_pwd_status === true ? 'Yes, I am' : "No, I'm not"}</Typography>
      ...
      <Grid container item xs={12} md={student_email ? 4 : 6} alignItems="center" spacing={2}>
        <Grid item>
          <IconPhone />
        </Grid>
        <Grid item sm>
      ...
      {student_same_address === false && (
        <Grid container item xs={12} alignItems="center" spacing={2}>
          ...
          <Grid item sm>
            <Typography variant="subtitle1">{student_permanent_address}</Typography>
      ...
      <Grid item xs={12}>
        <Divider textAlign="left">
          <Typography textTransform="uppercase">Family and Relationships</Typography>
        </Divider>
      </Grid>
      {student_father_name && (
        <>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            <Grid item>
              <IconUser />
            </Grid>
            <Grid item sm>
          ...
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_father_contact_number}</Typography>
              <Typography variant="overline">Contact</Typography>
            </Grid>
          </Grid>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_father_email_address}</Typography>
              <Typography variant="overline">Email</Typography>
            </Grid>
          </Grid>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_father_occupation}</Typography>
      ...
      {student_mother_name && (
        <>
          ...
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_mother_contact_number}</Typography>
              <Typography variant="overline">Contact</Typography>
            </Grid>
          </Grid>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_mother_email_address}</Typography>
              <Typography variant="overline">Email</Typography>
            </Grid>
          </Grid>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_mother_occupation}</Typography>
              <Typography variant="overline">Occupation</Typography>
            </Grid>
          </Grid>
        </>
      ...
      {student_guardian_name && (
        <>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_guardian_name}</Typography>
          ...
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_guardian_contact_number}</Typography>
              <Typography variant="overline">Contact</Typography>
            </Grid>
          </Grid>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_guardian_email_address}</Typography>
              <Typography variant="overline">Email</Typography>
            </Grid>
          </Grid>
          <Grid container item xs={12} md={6} lg={3} alignItems="center" spacing={2}>
            ...
            <Grid item sm>
              <Typography variant="subtitle1">{student_guardian_occupation}</Typography>
              <Typography variant="overline">Occupation</Typography>
            </Grid>
          </Grid>
        </>
