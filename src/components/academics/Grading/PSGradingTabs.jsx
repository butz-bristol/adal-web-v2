...
import FormMultipleIntelligence from './FormMultipleIntelligence';
import FormNarrativeReport from './FormNarrativeReport';
...
const PSGradingTabs = ({ setAlert, setQuarter, quarter }) => {
  ...
  const [validateIntelligence, setValidateIntelligence] = useState(false);
  const [validateBehavior, setValidateBehavior] = useState(false);
  const [validateNarrativeReport, setValidateNarrativeReport] = useState(false);
  ...
  const handleSubmitGrade = () => {
    ...
    const checkNarrativeReport = student_report?.narrative_report?.[quarter];
    ...
    <Fragment>
      ...
      >
        ...
        <Tab
          ...
          to="#"
          icon={
            validateNarrativeReport ? (
              <Tooltip
                open={validateNarrativeReport}
                title="Incomplete"
                placement="top"
                arrow
              >
