...
const K12EnrollmentReport = ({ enrollments }) => {
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell>Track/Strand</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {tableData.map((enrollment) => (
              <TableRow key={enrollment._id}>
                <TableCell>
                  <Typography>
                    {enrollment?.student?.student_last_name} {enrollment?.student?.student_first_name}{' '}
                    {enrollment?.student?.student_middle_name}
                  </Typography>
                ...
                <TableCell>{enrollment.student?.student_program?.program_name ?? 'N/A'}</TableCell>
              </TableRow>
            ))}
...
export default K12EnrollmentReport;
