...
const AddAdminCompensation = ({ hrview }) => {
  ...
  const {
    ...
    salary_grade,
    civil_statusOptions,
    editAdminCompensation,
    isCreatingAdminCompensation,
    isEditingAdminCompensation,
    isDeletingAdminCompensation,
    editAdminCompensationId,
    createAdminCompensationStatus,
    first_name,
    last_name,
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      dispatch(clearAdminCompensation());
    }, 1500);
  };
  ...
  return (
    <Modal
      open={createAdminCompensationStatus || editAdminCompensation}
      onClose={() => {
        createAdminCompensationStatus
          ? dispatch(toggleCreateAdminCompensation())
          : dispatch(toggleEditAdminCompensation());
        dispatch(clearAdminCompensation());
      }}
    ...
    >
      ...
      >
        <Typography gutterBottom variant="h4">
          {editAdminCompensation
            ? 'Edit Admin Compensation'
            : 'Add Admin Compensation'}
        </Typography>
        ...
        <form>
          <Grid container spacing={2} mt={3}>
            ...
            <Grid item xs={12}>
              ...
              >
                {editAdminCompensation ? 'Update' : 'Create'}
              </Button>
              ...
              {editAdminCompensation && (
                <Button
                  ...
                  sx={{ ml: 1 }}
                  onClick={() => {
                    dispatch(deleteAdminCompensation(editAdminCompensationId));
                    dispatch(toggleEditAdminCompensation());
                    dispatch(clearAdminCompensation());
                  }}
                >
...
export default AddAdminCompensation;
