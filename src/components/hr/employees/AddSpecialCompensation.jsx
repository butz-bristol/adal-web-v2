...
const AddSpecialDesignation = ({ hrview }) => {
  ...
  const {
    ...
    salary_grade,
    civil_statusOptions,
    createSpecialCompensationStatus,
    editSpecialCompensation,
    isCreatingSpecialCompensation,
    isEditingSpecialCompensation,
    isDeletingSpecialCompensation,
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      dispatch(clearSpecialCompensation());
    }, 1500);
  };
  ...
  return (
    <Modal
      open={createSpecialCompensationStatus || editSpecialCompensation}
      onClose={() => {
        createSpecialCompensationStatus
          ? dispatch(toggleCreateSpecialCompensation())
          : dispatch(toggleEditSpecialCompensation());
        dispatch(clearSpecialCompensation());
      }}
    ...
    >
      ...
      >
        <Typography gutterBottom variant="h4">
          {editSpecialCompensation
            ? 'Edit Special Compensation'
            : 'Add Special Compensation'}
        </Typography>
        ...
        <form>
          <Grid container spacing={2} mt={3}>
            ...
            <Grid item xs={12}>
              ...
              >
                {editSpecialCompensation ? 'Update' : 'Create'}
              </Button>
              ...
              {editSpecialCompensation && (
                <Button
                  ...
                  onClick={() => {
                    dispatch(
                      deleteSpecialCompensation(editSpecialCompensationId)
                    );
                    dispatch(toggleEditSpecialCompensation());
                    dispatch(clearSpecialCompensation());
                  }}
...
export default AddSpecialDesignation;
